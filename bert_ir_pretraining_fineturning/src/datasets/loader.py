...
def load_pahs(data_path, label_col, scheme, vocab_path, seq_len, bs, split="random", scale=1.0, seed=42):
...
def load_pahs_kfold(fold_idx, n_splits, data_path, label_col, scheme, vocab_path,
